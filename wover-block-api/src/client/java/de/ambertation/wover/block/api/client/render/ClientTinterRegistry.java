 ...
 * {@code BlockColor} - the tint analogue of {@code ClientBlockModelRegistry}. wover populates it with the
 ...
 * <p>
 * <b>Divergence from 26.x:</b> the resolved type is {@code BlockColor} rather than {@code BlockTintSource},
 * which does not exist before 26.1 - see {@link TintSourceFactory}. Method names and parameters are unchanged.
 */
@Environment(EnvType.CLIENT)
public class ClientTinterRegistry {
    private static final Map<TinterKey<?>, TintSourceFactory<?>> FACTORIES = new HashMap<>();
    private static final Map<Block, BlockColor> RESOLVED = new HashMap<>();
     ...
     */
    public static @Nullable BlockColor sourceFor(Block block) {
    ...
    public static @Nullable BlockColor resolve(TintBinding binding, Block block) {
