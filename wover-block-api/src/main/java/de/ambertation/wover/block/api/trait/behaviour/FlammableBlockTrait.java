 ...
 * {@link de.ambertation.wover.block.api.BlockDefinition#ignitedByLava()} combined with
 * {@link de.ambertation.wover.block.api.BlockRegistry#registerAsFlammable(net.minecraft.world.level.block.Block, int, int)}.
 * <p>
