...
import de.ambertation.wover.block.impl.BlockRegistryImpl;
 ...
 * {@link de.ambertation.wover.datagen.api.provider} to generate block tags.
 * <p>
...
public abstract class BlockRegistry {
    ...
    // Insertion-ordered for the same reason as ItemRegistry#items: allBlocks() is walked by the auto
    // datagen providers, so registration order is the order they emit in rather than key-hash order.
    private final Map<ResourceKey<Block>, Block> blocks = new LinkedHashMap<>();
     ...
     * Normally invoked automatically by {@link de.ambertation.wover.datagen.api.provider.AutoBlockRegistryTagProvider}.
     *
