 ...
 * its {@link org.betterx.wover.block.api.BlockDefinition} at runtime. WoVer never generates such a class
 * automatically - the block class must implement this interface itself (e.g. via a mixin) so
 * {@link org.betterx.wover.block.api.BlockDefinition#build()} can attach the traits.
 *
 * @param <B> The concrete block type
 */
public interface BlockWithTraits<B extends Block> {
    /**
     * Called once by {@link org.betterx.wover.block.api.BlockDefinition#build()} to attach the traits that
