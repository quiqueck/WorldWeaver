...
public interface BlockTrait<B extends Block, R extends RuntimeBlockTrait<B, R>> extends RuntimeBlockTrait<B, R> {
    ...
    /**
     * Called once the block has been built and registered with its {@link org.betterx.wover.block.api.BlockRegistry}.
     * Implementations typically use this to register the block with other systems (e.g.
     * {@link org.betterx.wover.block.api.BlockRegistry#registerAsFlammable(Block, int, int)}).
     *
