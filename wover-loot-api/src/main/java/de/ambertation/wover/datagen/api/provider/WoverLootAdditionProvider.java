 ...
 *     }
 *
 *     protected void bootstrap(HolderLookup.Provider lookup, BiConsumer<ResourceLocation, LootAdditionFile.Builder> consumer) {
...
public abstract class WoverLootAdditionProvider implements WoverDataProvider<DataProvider> {
     ...
     *
     * <p>The {@link ResourceLocation} is the file's id: it decides both the path the file is written to
    ...
    protected abstract void bootstrap(
            ...
            @NotNull BiConsumer<ResourceLocation, LootAdditionFile.Builder> consumer
    );
    ...
    private class Provider implements DataProvider {
        ...
        private Provider(FabricDataOutput output, CompletableFuture<HolderLookup.Provider> registryLookup) {
        ...
        public @NotNull CompletableFuture<?> run(@NotNull CachedOutput writer) {
            ...
            final Map<ResourceLocation, LootAdditionFile.Builder> files = new LinkedHashMap<>();
