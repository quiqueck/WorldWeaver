...
import de.ambertation.wover.feature.api.placed.modifiers.EveryLayer;
 ...
 * {@link de.ambertation.wover.feature.api.configured.configurators.FeatureConfigurator}
...
public interface FeaturePlacementBuilder {
     ...
     * @see de.ambertation.wover.feature.api.placed.modifiers.NoiseFilter
     */
     ...
     * is determined by {@link de.ambertation.wover.block.api.predicate.BlockPredicates#ONLY_GROUND},
     * which basically checks if the block has the {@link de.ambertation.wover.tag.api.predefined.CommonBlockTags#TERRAIN}
     * tag.
     * <p>
     ...
     *                      {@link de.ambertation.wover.feature.api.placed.modifiers.ExtendXYZ.HeightPropagation} for
     *                      Details.
     * @return this builder
     */
    ...
    /**
     * Will only accept positions if the block at the input position is air and
     * the block below matches the {@link de.ambertation.wover.block.api.predicate.BlockPredicates#ONLY_NYLIUM}-Predicate.
     * Otherwise, the position is rejected.
     *
     * @return this builder
     */
    ...
    /**
     * Will only accept positions if the block at the input position is air and
     * the block below matches the {@link de.ambertation.wover.block.api.predicate.BlockPredicates#ONLY_NETHER_GROUND}-Predicate.
     * Otherwise, the position is rejected.
     *
     * @return this builder
     */
    ...
    /**
     * Will only accept positions if the block at the input position is air and
     * the block above matches the {@link de.ambertation.wover.block.api.predicate.BlockPredicates#ONLY_NYLIUM}-Predicate.
     * Otherwise, the position is rejected.
     *
     * @return this builder
     */
    ...
    /**
     * Will only accept positions if the block at the input position is air and
     * the block above matches the {@link de.ambertation.wover.block.api.predicate.BlockPredicates#ONLY_NETHER_GROUND}-Predicate.
     * Otherwise, the position is rejected.
     *
     * @return this builder
     */
     ...
     * {@link de.ambertation.wover.feature.api.configured.configurators.AsSequence}).
     *
