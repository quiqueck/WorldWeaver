...
- **Gradle artifact:** `de.ambertation:worldweaver` (single artifact; this module ships inside it as the Fabric mod `wover-sets`)
- **Depends on:** `wover-core-api`, `wover-block-api`, `wover-item-api`, `wover-recipe-api`
- **Java packages:**
  - `de.ambertation.wover.sets.api.blocks` — the `BlockSet`/`WoodenBlockSet` builders and slot machinery
  - `de.ambertation.wover.sets.api.blocks.types` — one `SlotFactory` per block shape (planks, slab, stairs, door, chest, ...)
  - `de.ambertation.wover.sets.api.blocks.slots` — ready-made `SlotMap`s for a full wood or stone family
  - `de.ambertation.wover.sets.api.items` — support type for items registered as part of a set
  - `de.ambertation.wover.complex.api.equipment` — the `EquipmentSet` builder for tool/armor materials
  - `de.ambertation.wover.block.api.trait` (adds `BlockTraits`/`SignBlockDefinition`/`WallSignBlockDefinition` to the block module's package)
  - `de.ambertation.wover.block.api.trait.behaviour` (adds `BlockTagTrait`/`LootTableTrait`/`MineableWithTagTrait`/`StripableBlockTrait`/`ValidForBlockEntityTypeTrait`)
  - `de.ambertation.wover.block.api.trait.type` (adds `LogBlockTrait`/`BarkBlockTrait`)
  - `de.ambertation.wover.item.api.trait` (adds `ItemTraits`/`BoatItemTrait`/`ElytraItemTrait` to the item module's package)
  - `de.ambertation.wover.recipe.api` (adds `RecipeTraitLibrary` to the recipe module's package)
  - `de.ambertation.wover.block.api.client.model` / `de.ambertation.wover.block.api.client.trait` (client-only model traits)
  - `de.ambertation.wover.item.api.client.model` / `de.ambertation.wover.item.api.client.trait` (client-only, adds to the item module's client package)
...
- **Recipes are automatic.** Every block-type factory in `de.ambertation.wover.sets.api.blocks.types` attaches a
  ...
  itself.
- **Models need one explicit call.** `BlockModelTrait`/`ItemModelTrait` (in `de.ambertation.wover.block.api.client.trait`/
  `de.ambertation.wover.item.api.client.trait`) are *not* auto-registered — a client-side `WoverModelProvider`
...
- **Loot tables need one explicit call too.** A `WoverLootTableProvider` subclass must call
  ...
  this module's test mod `TestLootProvider`); `de.ambertation.wover.sets.api.blocks.types.Source` is the only
...
[`WoodenBlockSet`](../../../wover-sets-api/src/main/java/de/ambertation/wover/sets/api/blocks/WoodenBlockSet.java)
...
[`WoodSlots`](../../../wover-sets-api/src/main/java/de/ambertation/wover/sets/api/blocks/slots/WoodSlots.java) (planks,
...
[`getBlock(SlotType)`](../../../wover-sets-api/src/main/java/de/ambertation/wover/sets/api/blocks/BlockSet.java)/`getItem(SlotType)`
(or `getBlockWithFallback(SlotType...)`, which falls back through several slots, then the set's base slot, then
vanilla stone) — [`SlotType`](../../../wover-sets-api/src/main/java/de/ambertation/wover/sets/api/blocks/SlotType.java)
is the key identifying each role (`SlotType.LOG`, `SlotType.SLAB`, `SlotType.CHEST`, ...).

### Defining a stone set

A plain [`BlockSet`](../../../wover-sets-api/src/main/java/de/ambertation/wover/sets/api/blocks/BlockSet.java) has no
default slots of its own (`createDefaultDefinitions()` returns an empty map) — pick constants from
[`StoneSlots`](../../../wover-sets-api/src/main/java/de/ambertation/wover/sets/api/blocks/slots/StoneSlots.java) and
...
Every block-type factory in `de.ambertation.wover.sets.api.blocks.types`
([`Planks`](../../../wover-sets-api/src/main/java/de/ambertation/wover/sets/api/blocks/types/Planks.java),
[`Slab`](../../../wover-sets-api/src/main/java/de/ambertation/wover/sets/api/blocks/types/Slab.java),
[`Stairs`](../../../wover-sets-api/src/main/java/de/ambertation/wover/sets/api/blocks/types/Stairs.java),
[`Door`](../../../wover-sets-api/src/main/java/de/ambertation/wover/sets/api/blocks/types/Door.java),
[`Chest`](../../../wover-sets-api/src/main/java/de/ambertation/wover/sets/api/blocks/types/Chest.java), ...) extends
[`SlotFromDefinition`](../../../wover-sets-api/src/main/java/de/ambertation/wover/sets/api/blocks/SlotFromDefinition.java)
(or its wood-only variant,
[`WoodenSlotFromDefinition`](../../../wover-sets-api/src/main/java/de/ambertation/wover/sets/api/blocks/WoodenSlotFromDefinition.java)),
...
one `BlockItem`. [`SignBlockDefinition`](../../../wover-sets-api/src/main/java/de/ambertation/wover/block/api/trait/SignBlockDefinition.java)
(in `de.ambertation.wover.block.api.trait`, contributed by this module) handles that pairing —
`de.ambertation.wover.sets.api.blocks.types.Sign`/`HangingSign` build one, then override
...
- [`BlockTraits`](../../../wover-sets-api/src/main/java/de/ambertation/wover/block/api/trait/BlockTraits.java) adds
...
- [`ItemTraits`](../../../wover-sets-api/src/main/java/de/ambertation/wover/item/api/trait/ItemTraits.java) adds
...
block-type factories in `de.ambertation.wover.sets.api.blocks.types` use internally — using them directly is only
...
[`RecipeTraitLibrary`](../../../wover-sets-api/src/main/java/de/ambertation/wover/recipe/api/RecipeTraitLibrary.java)
(in `de.ambertation.wover.recipe.api`, contributed by this module) is the collection of ready-made recipe shapes
...
[`RecipeMaterial`](../../../wover-recipe-api/src/main/java/de/ambertation/wover/recipe/api/RecipeMaterial.java)
...
[`EquipmentSet`](../../../wover-sets-api/src/main/java/de/ambertation/wover/complex/api/equipment/EquipmentSet.java) is
...
[`ToolTier`](../../../wover-sets-api/src/main/java/de/ambertation/wover/complex/api/equipment/ToolTier.java)/
[`ArmorTier`](../../../wover-sets-api/src/main/java/de/ambertation/wover/complex/api/equipment/ArmorTier.java) pair
(ready-made vanilla tiers live in
[`ToolTiers`](../../../wover-sets-api/src/main/java/de/ambertation/wover/complex/api/equipment/ToolTiers.java)/
[`ArmorTiers`](../../../wover-sets-api/src/main/java/de/ambertation/wover/complex/api/equipment/ArmorTiers.java)).
