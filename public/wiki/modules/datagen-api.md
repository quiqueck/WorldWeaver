...
- **Gradle artifact:** `org.betterx:wover-datagen-api`
- **Depends on:** `wover-core-api`
- **Java packages:**
  - `org.betterx.wover.datagen.api`
  - `org.betterx.wover.datagen.api.provider`
  - `org.betterx.wover.datagen.api.provider.multi`
...
[`WoverDataGenEntryPoint`](../../wover-datagen-api/src/main/java/org/betterx/wover/datagen/api/WoverDataGenEntryPoint.java),
registered as a `fabric-datagen` entrypoint in your `fabric.mod.json`:

```json
"entrypoints": {
  "fabric-datagen": ["org.betterx.mymod.datagen.MyModDatagen"]
}
```
...
[`org.betterx.wover.datagen.api` package Javadoc](../../wover-datagen-api/src/main/java/org/betterx/wover/datagen/api/package-info.java)
...
[`addDatapack(ResourceLocation)`](../../wover-datagen-api/src/main/java/org/betterx/wover/datagen/api/WoverDataGenEntryPoint.java)
...
[`PackBuilder`](../../wover-datagen-api/src/main/java/org/betterx/wover/datagen/api/PackBuilder.java)
is the object you attach content to, once per Datapack. It has three registration methods:

| Method | Registers |
|---|---|
| `addRegistryProvider(PackBuilder.RegistryFactory<T>)` | A [`WoverRegistryProvider<T>`](../../wover-datagen-api/src/main/java/org/betterx/wover/datagen/api/WoverRegistryProvider.java) that bootstraps and serializes elements of a dynamic `Registry<T>`. |
| `addProvider(PackBuilder.ProviderFactory<T>)` | Any other [`WoverDataProvider<T>`](../../wover-datagen-api/src/main/java/org/betterx/wover/datagen/api/WoverDataProvider.java) (tags, recipes, loot tables, models, ...). |
| `addMultiProvider(PackBuilder.MultiProviderFactory<T>)` | A [`WoverMultiProvider`](../../wover-datagen-api/src/main/java/org/betterx/wover/datagen/api/WoverMultiProvider.java) that internally registers several providers at once. |
...
| Class | Serializes |
|---|---|
| [`WoverFullRegistryProvider<T>`](../../wover-datagen-api/src/main/java/org/betterx/wover/datagen/api/WoverFullRegistryProvider.java) | **All** elements of the registry whose namespace passes a `Predicate<String>` (by default: just the mod's own namespace). |
| [`WoverRegistryContentProvider<T>`](../../wover-datagen-api/src/main/java/org/betterx/wover/datagen/api/WoverRegistryContentProvider.java) | **Only** the elements that were registered inside this particular provider's own `bootstrap(BootstrapContext<T>)` method — useful when you need several providers for the same registry, each feeding a different Datapack. |

Both extend [`WoverRegistryProvider<T>`](../../wover-datagen-api/src/main/java/org/betterx/wover/datagen/api/WoverRegistryProvider.java),
which you can also subclass directly for full control. The
[`org.betterx.wover.datagen.api.provider`](../../wover-datagen-api/src/main/java/org/betterx/wover/datagen/api/provider)
...
| Class | Registry |
|---|---|
| [`WoverBiomeOnlyProvider`](../../wover-datagen-api/src/main/java/org/betterx/wover/datagen/api/provider/WoverBiomeOnlyProvider.java) | `Registries.BIOME` |
| [`WoverConfiguredFeatureProvider`](../../wover-datagen-api/src/main/java/org/betterx/wover/datagen/api/provider/WoverConfiguredFeatureProvider.java) | `Registries.CONFIGURED_FEATURE` |
| [`WoverPlacedFeatureProvider`](../../wover-datagen-api/src/main/java/org/betterx/wover/datagen/api/provider/WoverPlacedFeatureProvider.java) | `Registries.PLACED_FEATURE` |
| [`WoverStructureProvider`](../../wover-datagen-api/src/main/java/org/betterx/wover/datagen/api/provider/WoverStructureProvider.java) | `Registries.STRUCTURE` |
| [`WoverStructureSetProvider`](../../wover-datagen-api/src/main/java/org/betterx/wover/datagen/api/provider/WoverStructureSetProvider.java) | `Registries.STRUCTURE_SET` |
| [`WoverStructurePoolProvider`](../../wover-datagen-api/src/main/java/org/betterx/wover/datagen/api/provider/WoverStructurePoolProvider.java) | `Registries.TEMPLATE_POOL` |
| [`WoverStructureProcessorProvider`](../../wover-datagen-api/src/main/java/org/betterx/wover/datagen/api/provider/WoverStructureProcessorProvider.java) | `Registries.PROCESSOR_LIST` |

Each takes a `ModCore` and an optional `ResourceLocation providerId` (needed only when you register more than one
...
[`WoverMultiProvider`](../../wover-datagen-api/src/main/java/org/betterx/wover/datagen/api/WoverMultiProvider.java)
(or extend the convenience base class
[`AbstractMultiProvider`](../../wover-datagen-api/src/main/java/org/betterx/wover/datagen/api/AbstractMultiProvider.java),
...
[`org.betterx.wover.datagen.api.provider.multi`](../../wover-datagen-api/src/main/java/org/betterx/wover/datagen/api/provider/multi)
package includes
[`WoverFeatureProvider`](../../wover-datagen-api/src/main/java/org/betterx/wover/datagen/api/provider/multi/WoverFeatureProvider.java)
...
[`WoverDataGenEntryPoint.registerAutoProvider(PackBuilder.ProviderFactory<T>)`](../../wover-datagen-api/src/main/java/org/betterx/wover/datagen/api/WoverDataGenEntryPoint.java)
during mod init. The created provider must implement the marker interface
[`WoverAutoProvider`](../../wover-datagen-api/src/main/java/org/betterx/wover/datagen/api/WoverAutoProvider.java)
...
[`WoverDataProvider.Secondary<T>`](../../wover-datagen-api/src/main/java/org/betterx/wover/datagen/api/WoverDataProvider.java)
