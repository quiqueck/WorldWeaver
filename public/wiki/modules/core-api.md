...
- **Gradle artifact:** `de.ambertation:worldweaver` (single artifact; this module ships inside it as the Fabric mod `wover-core`)
- **Depends on:** `wover-common-api`
- **Java packages:**
  - `de.ambertation.wover.core.api`
  - `de.ambertation.wover.core.api.registry`
  - `de.ambertation.wover.config.api`
  - `de.ambertation.wover.legacy.api`
...
- [`DatapackRegistryBuilder`](../../../wover-core-api/src/main/java/de/ambertation/wover/core/api/registry/DatapackRegistryBuilder.java)
  ...
  `wover-core-api`.
- [`DatapackConfigs`](../../../wover-core-api/src/main/java/de/ambertation/wover/config/api/DatapackConfigs.java) can load
...
[`ModCore`](../../../wover-core-api/src/main/java/de/ambertation/wover/core/api/ModCore.java) identifies your mod and
...
| `log` / `LOG` | A [`Logger`](../../../wover-core-api/src/main/java/de/ambertation/wover/core/api/Logger.java) (wraps `wunderlib`'s logger) named after your mod id. |
| `id(String name)` / `mk(String key)` | Build an `Identifier` in your mod's namespace — prefer this over `Identifier.fromNamespaceAndPath(...)`. |
...
[`IntegrationCore`](../../../wover-core-api/src/main/java/de/ambertation/wover/core/api/IntegrationCore.java) exposes
...
[`Configs`](../../../wover-core-api/src/main/java/de/ambertation/wover/config/api/Configs.java) is a small registry for
`de.ambertation.wunderlib.configs.AbstractConfig` instances (usually a `ConfigFile` subclass, see
[`MainConfig`](../../../wover-core-api/src/main/java/de/ambertation/wover/config/api/MainConfig.java) for WorldWeaver's
own example):
...
[`DatapackConfigs.instance()`](../../../wover-core-api/src/main/java/de/ambertation/wover/config/api/DatapackConfigs.java):
...
[`BuiltInRegistryManager`](../../../wover-core-api/src/main/java/de/ambertation/wover/core/api/registry/BuiltInRegistryManager.java):
...
[`DatapackRegistryEntrypoint`](../../../wover-core-api/src/main/java/de/ambertation/wover/core/api/registry/DatapackRegistryEntrypoint.java),
...
[`CustomBootstrapContext`](../../../wover-core-api/src/main/java/de/ambertation/wover/core/api/registry/CustomBootstrapContext.java)
...
[`LegacyHelper`](../../../wover-core-api/src/main/java/de/ambertation/wover/legacy/api/LegacyHelper.java) offers
