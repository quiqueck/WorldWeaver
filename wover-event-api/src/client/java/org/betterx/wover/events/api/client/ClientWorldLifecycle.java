...
public class ClientWorldLifecycle {
     ...
     * process by returning {@code true}. If one subscriber cancels the loading process,
     ...
     * that is passed as a parameter in {@link BeforeClientLoadScreen#process(LevelStorageSource, String, VoidFunction)}
     */
