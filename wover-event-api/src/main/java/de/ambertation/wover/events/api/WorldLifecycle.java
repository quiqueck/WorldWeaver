...
import de.ambertation.wover.events.api.types.*;
 ...
 * more often (once for every {@link de.ambertation.wover.events.api.types.OnRegistryReady.Stage}). Since
...
public class WorldLifecycle {
     ...
     * {@link de.ambertation.wover.events.api.types.OnRegistryReady.Stage} value that is sent along to
     * subscribers. Only a registry flagged with
     * {@link de.ambertation.wover.events.api.types.OnRegistryReady.Stage#FINAL} is the one that is used
     * in the actual world.
     * <p>
     ...
     * {@link #WORLD_REGISTRY_READY} was fired with {@link de.ambertation.wover.events.api.types.OnRegistryReady.Stage#FINAL}),
