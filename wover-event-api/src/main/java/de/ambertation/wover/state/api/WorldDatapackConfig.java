 ...
 * (re-)loaded, i.e. on {@link de.ambertation.wover.events.api.WorldLifecycle#BEFORE_LOADING_RESOURCES} and
 * {@link de.ambertation.wover.events.api.WorldLifecycle#RESOURCES_LOADED}. Every JSON file across all loaded datapacks
 ...
 * {@link de.ambertation.wover.events.api.Event#DEFAULT_PRIORITY} unless it specifies its own {@code priority}) and
