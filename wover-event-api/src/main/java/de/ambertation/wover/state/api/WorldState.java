...
public class WorldState {
     ...
     * {@link de.ambertation.wover.events.api.WorldLifecycle#WORLD_REGISTRY_READY} event.
     * Only Registries that are not sent with the {@link de.ambertation.wover.events.api.types.OnRegistryReady.Stage}
     * {@link de.ambertation.wover.events.api.types.OnRegistryReady.Stage#PREPARATION}
     ...
     * {@link de.ambertation.wover.events.api.WorldLifecycle#WORLD_FOLDER_READY} event.
     *
