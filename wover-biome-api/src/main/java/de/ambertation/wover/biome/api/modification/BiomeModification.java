...
import de.ambertation.wover.biome.impl.modification.BiomeModificationImpl;
import de.ambertation.wover.biome.impl.modification.FeatureMap;
import de.ambertation.wover.biome.impl.modification.GenerationSettingsWorker;
import de.ambertation.wover.biome.impl.modification.MobSettingsWorker;
 ...
 * <p>
 * The Modification API uses the {@link de.ambertation.wover.events.api.WorldLifecycle#MINECRAFT_SERVER_READY}
...
public interface BiomeModification {
    ...
    final class Builder {
         ...
         * {@link de.ambertation.wover.config.api.Configs#register(Supplier)} or
         * {@link de.ambertation.wover.config.api.Configs#register(ModCore, String, Configs.ConfigSupplier)}.
