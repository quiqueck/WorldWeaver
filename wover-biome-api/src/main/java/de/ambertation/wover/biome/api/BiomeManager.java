...
public class BiomeManager {
    ...
    /**
     * Fired whenever the internal {@link de.ambertation.wover.biome.api.builder.BiomeBootstrapContext} used to
     * gather all {@link BiomeBuilder}s is (re-)created. This is used internally to collect the builders
     * created by {@link BiomeKey#bootstrap(de.ambertation.wover.biome.api.builder.BiomeBootstrapContext)} and
     ...
     * <p>
     * Call {@link BiomeKey#bootstrap(de.ambertation.wover.biome.api.builder.BiomeBootstrapContext)} on the
     * returned key (usually from a {@link de.ambertation.wover.biome.api.builder.event.OnBootstrapBiomes}
     * subscriber or a {@link de.ambertation.wover.datagen.api.provider.multi.WoverBiomeProvider}) to obtain a
