 ...
 * <p>
 * {@link de.ambertation.wover.pottable.api.PottablePlantRegistry} and
 * {@link de.ambertation.wover.pottable.api.PottableSoilRegistry} are the entry points, mirroring each other: each
 ...
 * {@link de.ambertation.wover.pottable.api.PottablePlant} (respectively
 * {@link de.ambertation.wover.pottable.api.PottableSoil}) that just references the block and, for plants, the
 ...
 * Most mods won't call these methods directly; see {@link de.ambertation.wover.pottable.api.trait} and
 * {@link de.ambertation.wover.pottable.api.datagen} for the block-trait-driven, no-boilerplate way of registering
