 ...
 * Tag Managment API
 * <p>
 * The {@link de.ambertation.wover.tag.api.TagManager} is the main entry point for the API. It provides access
 * to {@link de.ambertation.wover.tag.api.TagRegistry}s that manage typical tag types. It also allows you to create
 * custom {@link de.ambertation.wover.tag.api.TagRegistry}s.
 * <p>
 * A {@link de.ambertation.wover.tag.api.TagRegistry} is primarily used to create {@link net.minecraft.tags.TagKey}s.
 * This example will add a new Block-Tag to the mods Namespace with {@code C} beeing an Instance of the Mod's
 * {@link de.ambertation.wover.core.api.ModCore}:
 ...
 * {@link de.ambertation.wover.tag.api.ItemTagDataProvider} and {@link de.ambertation.wover.tag.api.BlockTagDataProvider}.
 ...
 * to subscribe to the {@link de.ambertation.wover.tag.api.TagRegistry#bootstrapEvent()} to add elements to a Tag.
