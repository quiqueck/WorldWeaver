...
import de.ambertation.wover.tag.api.builder.TagBuilder;
...
/**
 * Provides the BootstrapContext for the {@link de.ambertation.wover.tag.api.TagRegistry#bootstrapEvent()}
