...
import de.ambertation.wover.surface.impl.numeric.RandomIntProvider;
...
public class NumericProviders {
    ...
    /**
     * A Numeric sequence based on {@link de.ambertation.wover.surface.api.Conditions#NETHER_VOLUME_NOISE}.
     ...
     * {@link de.ambertation.wover.surface.api.Conditions#NETHER_VOLUME_NOISE}.
     * <p>
     * You can use this numeric provider in a .json file like this:
     * <pre class="json"> {
