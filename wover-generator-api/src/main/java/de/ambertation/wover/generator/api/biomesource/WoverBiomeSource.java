...
import de.ambertation.wover.common.generator.api.biomesource.BiomeSourceWithSeed;
...
import de.ambertation.wover.generator.impl.biomesource.WoverBiomeSourceImpl;
 ...
 * ({@link de.ambertation.wover.generator.impl.biomesource.nether.WoverNetherBiomeSource
 * WoverNetherBiomeSource}/{@link de.ambertation.wover.generator.impl.biomesource.end.WoverEndBiomeSource
 * WoverEndBiomeSource}).
 * <p>
 ...
 * {@link de.ambertation.wover.common.generator.api.chunkgenerator.EnforceableChunkGenerator
...
public abstract class WoverBiomeSource extends BiomeSource implements
     ...
     * {@link de.ambertation.wover.generator.api.map.BiomeMap BiomeMap}(s).
     *
     ...
     * {@link de.ambertation.wover.generator.api.biomesource.end.BiomeDecider BiomeDecider}s override this to
     * also rebuild those.
     *
     ...
     * {@link de.ambertation.wover.generator.api.map.BiomeMap BiomeMap}(s) for the current seed.
     *
     ...
     * {@inheritDoc}
     * <p>
     * Always forces a full rebuild of the picker map and {@link de.ambertation.wover.generator.api.map.BiomeMap
     * BiomeMap}(s).
     */
    @Override
    ...
    /**
     * Re-initializes this source's {@link de.ambertation.wover.generator.api.map.BiomeMap BiomeMap}(s) for the
