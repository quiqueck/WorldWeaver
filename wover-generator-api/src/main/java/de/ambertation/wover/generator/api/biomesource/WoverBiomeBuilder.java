...
import de.ambertation.wover.generator.impl.biomesource.builder.WoverBiomeKeyImpl;
import de.ambertation.wover.generator.impl.biomesource.builder.WrappedWoverBiomeKeyImpl;
...
/**
 * Extends {@link BiomeBuilder} with the extra placement data that WoVer's own {@link WoverBiomeSource}
...
public interface WoverBiomeBuilder<B extends BiomeBuilder<B>> {
     ...
     * <p>
     * Mirrors {@link de.ambertation.wover.biome.api.BiomeManager#wrapped(ResourceKey)}, but with the
