...
import de.ambertation.wover.block.api.trait.behaviour.*;
import de.ambertation.wover.block.api.trait.type.BarkBlockTrait;
...
import de.ambertation.wover.block.impl.trait.behaviour.*;
import de.ambertation.wover.block.impl.trait.material.*;
import de.ambertation.wover.block.impl.trait.type.*;

/**
 * Central registry of every ready-made {@link de.ambertation.wover.block.api.trait.BlockTrait} builder shipped by
 ...
 * {@link de.ambertation.wover.block.api.BlockDefinition#addTrait(de.ambertation.wover.block.api.trait.BlockTrait)}
 ...
 * {@code de.ambertation.wover.sets.api.blocks.types} use to configure the blocks they build.
 */
public class BlockTraits {
    ...
    // Material Traits
    /**
     * Marks a block as belonging to the "stone" material family (used by {@link de.ambertation.wover.sets.api.blocks.types.Button} to pick timings, recipe groups, ...).
     */
    public static final GenericBlockTrait.TagOnlyBuilderWithDefaults STONE_BLOCK = StoneMaterialBuilder.BUILDER;
    /**
     * Marks a block as belonging to the "metal" material family.
     */
    public static final GenericBlockTrait.TagOnlyBuilderWithDefaults METAL_BLOCK = MetalMaterialBuilder.BUILDER;
    /**
    ...
    /**
     * Marks a block as belonging to the "plant-derived light source" material family (the shroomlight archetype), see {@link PlantLightMaterialBuilder}.
     */
    public static final GenericBlockTrait.BuilderWithDefaults PLANT_LIGHT_BLOCK = PlantLightMaterialBuilder.BUILDER;
    ...
    public static final GenericBlockTrait.BuilderWithDefaults CHAIN_BLOCK = ChainBlockBuilder.BUILDER;
    public static final GenericBlockTrait.BuilderWithDefaults BARS_BLOCK = BarsBlockBuilder.BUILDER;
