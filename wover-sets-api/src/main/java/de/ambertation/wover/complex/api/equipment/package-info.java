 ...
 * <ul>
 *   <li>{@link de.ambertation.wover.complex.api.equipment.EquipmentSet} - subclassed to define a set; call
 *   {@code add(ToolSlot)}/{@code add(ArmorSlot)} for every piece the set should contain</li>
 *   <li>{@link de.ambertation.wover.complex.api.equipment.ToolTier} / {@link de.ambertation.wover.complex.api.equipment.ToolTiers} -
 *   per-material tool configuration (attack stats, mining tag, smithing template); ready-made vanilla tiers</li>
 *   <li>{@link de.ambertation.wover.complex.api.equipment.ArmorTier} / {@link de.ambertation.wover.complex.api.equipment.ArmorTiers} -
 *   per-material armor configuration (durability, smithing template); ready-made vanilla tiers</li>
 *   <li>{@link de.ambertation.wover.complex.api.equipment.ToolSlot} / {@link de.ambertation.wover.complex.api.equipment.ArmorSlot} -
 *   the pieces an {@code EquipmentSet} can register</li>
 *   <li>{@link de.ambertation.wover.complex.api.equipment.ToolDescription} / {@link de.ambertation.wover.complex.api.equipment.ArmorDescription} -
