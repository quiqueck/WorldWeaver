 ...
 * {@code de.ambertation.wover.sets.api.blocks.slots.WoodSlots}/{@code StoneSlots}) can simply construct a new
 * {@code SlotType} with an arbitrary suffix, as done by e.g.
 * {@code de.ambertation.wover.sets.api.blocks.types.HangingSign#HANGING_WALL_SIGN}.
 *
...
public record SlotType(String suffix) {
    ...
    /** A vanilla 1.21.9-style {@link net.minecraft.world.level.block.ShelfBlock}: the wall-mounted, three-slot
     *  display shelf crafted from stripped logs. */
    public static final SlotType SHELF = new SlotType("shelf");
    ...
    /** A raft (e.g. vanilla's bamboo raft): an {@link de.ambertation.wover.sets.api.blocks.types.Boat} slot built
