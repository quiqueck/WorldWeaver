 ...
 * {@link WoodSlots}, {@link de.ambertation.wover.sets.api.blocks.BlockSet} does not build any of these by default -
 * a stone-like set picks the constants it wants and combines them with
 * {@link de.ambertation.wover.sets.api.blocks.SlotMap#of} (see {@code TestStoneSet} in this module's test mod).
 */
