 ...
 * {@link SlotFromDefinition} (builds a new block via {@link de.ambertation.wover.block.api.BlockDefinition}), plus
 * the ready-made block-type factories in {@code de.ambertation.wover.sets.api.blocks.types}.
 */
