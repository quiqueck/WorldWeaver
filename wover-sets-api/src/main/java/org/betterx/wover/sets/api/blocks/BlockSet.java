 ...
 * {@code org.betterx.wover.sets.api.blocks.slots.StoneSlots}/{@code WoodSlots} and adding/removing/replacing
 ...
 * {@link org.betterx.wover.sets.api.blocks.WoodenBlockSet} for the wood-specific subclass, and this module's test
 * mod ({@code TestStoneSet}/{@code TestWoodSet}) for worked examples.
 *
 * @param <S> the concrete subclass, for fluent chaining (see {@link #setPlanksColor} on
 *            {@link org.betterx.wover.sets.api.blocks.WoodenBlockSet})
 */
public class BlockSet<S extends BlockSet<S>> {
     ...
     * under this set's namespace/name; {@link org.betterx.wover.sets.api.blocks.WoodenBlockSet} overrides this to
     ...
     * {@code org.betterx.wover.sets.api.blocks.slots} and calling {@link SlotMap#add}/{@link SlotMap#replace}/
     ...
     * map color); see {@link org.betterx.wover.sets.api.blocks.WoodenBlockSet} for an example. The default
     ...
     * how slot factories in {@code org.betterx.wover.sets.api.blocks.types} build recipes for a block that
