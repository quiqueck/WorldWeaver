 ...
 * addition to) a block, e.g. {@code org.betterx.wover.sets.api.blocks.types.Boat}.
 * <p>
...
public class ItemSlotFromDefinition extends SlotFromDefinition {
    ...
    /**
     * Builds the client-side model trait for this slot's item. The default implementation returns {@code null}
