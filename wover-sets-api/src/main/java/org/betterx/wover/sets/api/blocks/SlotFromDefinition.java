 ...
 * {@link org.betterx.wover.block.api.BlockDefinition}, deriving its registration name from the owning
 * {@link BlockSet}'s base name and this slot's suffix.
 * <p>
 * This is the base class extended by every block-type factory in
 * {@code org.betterx.wover.sets.api.blocks.types} (e.g. {@code Slab}, {@code Stairs}, {@code Door}). Subclasses
 ...
 * {@code org.betterx.wover.sets.api.blocks.types.Sign}/{@code HangingSign}, which report both the primary and
 * wall sign block).
 */
public class SlotFromDefinition implements SlotFactory {
    ...
    /**
     * Builds the client-side model trait for this slot's block. The default implementation returns {@code null}
     * (no model generated). Only called when {@link ModCore#isClient()}.
     *
     * @param set         the block set this factory belongs to
