...
public class CustomArmorMaterial {
    ...
    public static class Builder {
        ...
        /**
         * Configures a fully custom {@link EquipmentAssetSpec} for this material's equipment asset,
         * generated at datagen time under whatever {@code assetId} this material ends up using (either
         ...
         *         .addHumanoidLayers(MyMod.C.mk("aeternium"))
         *         .addWingsLayer(MyMod.C.mk("elytra_armored")))
         * </pre>
         *
         * @param configurer A callback that populates the {@link EquipmentAssetSpec}
         * @return This builder instance for chaining
         */
        public Builder equipmentAsset(Consumer<EquipmentAssetSpec> configurer) {
            final EquipmentAssetSpec spec = EquipmentAssetSpec.create();
            configurer.accept(spec);
            this.equipmentAsset = spec;
            return this;
        }

        /**
         * Declares the standard humanoid armor equipment asset (a {@code humanoid} + {@code humanoid_leggings}
         * layer, both using this material's own location as the texture id) - the shape almost every plain
        ...
        /**
         * Same as {@link #humanoidEquipmentAsset()}, but lets you use a texture id other than the
         * material's own location - useful when several materials should share one texture.
         *
        ...
        /**
         * Declares a {@code wings}-only equipment asset (with {@code use_player_texture} set), for materials
         * whose sole purpose is rendering an elytra.
         *
        ...
        public ArmorMaterial build() {
            ...
            validate();
            if (equipmentAsset != null && !equipmentAsset.isEmpty()) {
                EquipmentAssetRegistry.register(assetId, equipmentAsset);
            }
