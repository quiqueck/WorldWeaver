 ...
 * {@link org.betterx.wover.item.api.ItemDefinition#addTrait(ItemTrait) addTrait(...)}.
 *
...
public interface ItemTraitBuilder<I extends Item, R extends RuntimeItemTrait<I, R>> {
     ...
     * {@link org.betterx.wover.item.api.ItemDefinition#addTrait(WithDefault) addTrait(...)}.
     *
     ...
     * {@link org.betterx.wover.item.api.ItemDefinition#addTrait(WithDefaults) addTrait(...)}.
     *
     * @param <I> The item type the built traits apply to
