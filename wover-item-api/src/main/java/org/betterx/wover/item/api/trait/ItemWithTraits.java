 ...
 *
 * <p>{@link org.betterx.wover.item.api.ItemDefinition#build()} automatically calls
 * {@link #wover_setItemTraits(List)} with the runtime traits collected from every
 * {@link org.betterx.wover.item.api.ItemDefinition#addTrait(ItemTrait) addTrait(...)} call whose
...
public interface ItemWithTraits<I extends Item> {
     ...
     * {@link org.betterx.wover.item.api.ItemDefinition#build()}.
     *
