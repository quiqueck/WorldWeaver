...
public interface StructureKey<
     ...
     * build a new Structure tag by using {@link de.ambertation.wover.tag.api.BiomeTagRegistry#makeStructureTag(ModCore, String)} (ModCore, String)}
     * from {@link de.ambertation.wover.tag.api.TagManager#BIOMES}.
     *
