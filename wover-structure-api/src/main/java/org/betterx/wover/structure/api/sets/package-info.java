 ...
 * <p>
 * {@link org.betterx.wover.structure.api.sets.StructureSetManager} creates a
 * {@link org.betterx.wover.structure.api.sets.StructureSetKey} — a wrapper around a
 * {@link net.minecraft.resources.ResourceKey} for the set. Call
 * {@link org.betterx.wover.structure.api.sets.StructureSetKey#bootstrap(net.minecraft.data.worldgen.BootstrapContext)}
 * to obtain a {@link org.betterx.wover.structure.api.sets.StructureSetBuilder} and register the set:
 ...
 *       .register();</pre>
 * {@link org.betterx.wover.structure.api.sets.StructureSetManager#bootstrap(org.betterx.wover.structure.api.StructureKey, net.minecraft.data.worldgen.BootstrapContext)}
